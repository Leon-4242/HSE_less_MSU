/****************************************************************************
** Meta object code from reading C++ file 'CommonDefs.h'
**
...
#error "The header file 'CommonDefs.h' doesn't include <QObject>."
...
void Data::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Data::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Data::changed)) {
                *result = 0;
                return;
            }
        }
